...
{#if isActive}
  ...
  <div in:fade={{ duration: 200, easing: expoOut }} out:fade={{ duration: 200, easing: expoIn }} class="overlay fixed top-0 left-0 w-full h-full block md:hidden z-3 opacity-75"></div>
{/if}
